...
const URL = 'https://www.scan-vf.net/kingdom'
...
async function scrapeChapitresKingdom() {
    try {
        ...
        $('a[href*="/kingdom/chapitre-"]').each((index, element) => {
        ...
        console.error('Erreur de sraping:', error);
    } finally {
        db.end()
    }
}

scrapeChapitresKingdom()